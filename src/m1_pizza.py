...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = 'Tests 4:  8 red on pink;  20 yellow on blue.'
    window = rg.RoseWindow(440, 400, title)
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    title = 'PIZZA test 4:  200 slices, thin (thickness=2) pink lines.'
    window = rg.RoseWindow(600, 600, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
    circle.fill_color = 'black'
    pizza(window, circle, 200, 'pink', 2)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'POLYGON tests 3: 4 segments with black lines on lime green circle'
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    line1= rg.Line(points[len(points)-1], points[0])
...
def run_test_fancy_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'FANCY POLYGON test 4:  51 lime red lines on blue circle, hops = 25.'
